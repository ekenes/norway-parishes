import{E as g}from"./BufferObject-D_G2MlPC.js";import{r as c}from"./Program-D7V6mRHz.js";import{x as j,s as F}from"./Program-D7V6mRHz.js";import"./index-CaYX07dN.js";import{t as p}from"./NestedMap-GuqgquCN.js";import{e as O,a as P}from"./ProgramTemplate-IGwNOKYc.js";import{m as A}from"./Texture-Cm9QHY0k.js";import{o as q}from"./VertexArrayObject-CQ6o71wB.js";import"./enums-Dk3osxpS.js";class d{constructor(e){this._rctx=e,this._store=new p}dispose(){this._store.forAll(e=>e.dispose()),this._store.clear()}acquire(e,t,o,n){const r=this._store.get(e,t);if(r!=null)return r.ref(),r;const s=new c(this._rctx,e,t,o,n);return s.ref(),this._store.set(e,t,s),s}get test(){}}function m(i){const{options:e,value:t}=i;return typeof e[t]=="number"}function b(i){let e="";for(const t in i){const o=i[t];if(typeof o=="boolean")o&&(e+=`#define ${t}
...
//# sourceMappingURL=webglDeps-Bcigo5sn.js.map

import{m5 as ft,kD as dt,aP as ve,V as q,v as Ee,s as Se,ds as Oe,bn as Ae,I as Te,gn as _t,gp as Pe,ao as mt}from"./index-Club40b3.js";import{w as Ce,a as ue,f as vt,g as pt,h as gt,i as ht,Z as F,_ as $e,$ as De}from"./definitions-DyYHcW4a.js";import{e as xt,b as yt,h as Ze,f as L,n as re,s as le,r as St}from"./LabelMetric-BY4xyzGw.js";import{E as k}from"./BufferObject-Ca7mh5az.js";import{C as P,F as W,E as A,R as N,O as U,L as B,I as Q,N as Tt,D as bt}from"./enums-Dk3osxpS.js";import{o as Z}from"./VertexArrayObject-DrBWj3TA.js";import{t as ne}from"./VertexElementDescriptor-BLyltQyJ.js";import{e as It,a as ce}from"./ProgramTemplate-DCFRBwYq.js";import{n as pe}from"./mat2df32-orApM5a3.js";import{r as Ke,i as ge,s as Et}from"./mat3-DrMmd9ov.js";import{e as ie,N as he,S as Re,f as Ot,n as At,E as ee}from"./MapView-BeVuNCRF.js";import{o as Pt,N as Ct}from"./vec32-Aogwsubb.js";import{n as Dt}from"./vec3f32-nZdmKIgz.js";import{e as je,n as Rt}from"./Container-BiFGiH8X.js";import{e as Lt}from"./TileKey-Ba8uBVQH.js";import{p as Mt,m as zt}from"./Texture-BcrxBDUu.js";import{r as J,l as G,n as Le}from"./StyleDefinition-CQNr1s2Q.js";import{n as Vt,t as Nt}from"./vec2f32-BbH2jxlN.js";import{e as Me}from"./config-BOD8--da.js";import{e as wt}from"./earcut-D9gy186-.js";import{Q as Ft,K as Bt}from"./featureConversionUtils-BBYylpiA.js";let Ut=class extends je{constructor(e,t,n,i,o,a,r=o,l=a){super(),this.tileDebugInfoTexture=null,this.debugInfo={display:{length:0,minOrderedLength:0,minUnorderedLength:0,triangleCount:0},memory:{bytesUsed:0,bytesReserved:0}},this._destroyed=!1,this.key=new Lt(e),this.resolution=t,this.x=n,this.y=i,this.width=o,this.height=a,this.rangeX=r,this.rangeY=l}destroy(){this.tileDebugInfoTexture&&(this.tileDebugInfoTexture.dispose(),this.tileDebugInfoTexture=null),this._destroyed=!0}get debugSlot(){let e=this;for(;e.parent!==this._stage;){if(!e.parent)return 0;e=e.parent}return this._stage.children.indexOf(e)}setTransform(e){const t=this.resolution/(e.resolution*e.pixelRatio),n=this.transforms.tileMat3,[i,o]=e.toScreenNoRotation([0,0],[this.x,this.y]),a=this.width/this.rangeX*t,r=this.height/this.rangeY*t;Ke(n,a,0,0,0,r,0,i,o,1),ge(this.transforms.displayViewScreenMat3,e.displayViewMat3,n)}get destroyed(){return this._destroyed}};function qe(){return new Float32Array(4)}function Gt(u){const e=new Float32Array(4);return e[0]=u[0],e[1]=u[1],e[2]=u[2],e[3]=u[3],e}function H(u,e,t,n){const i=new Float32Array(4);return i[0]=u,i[1]=e,i[2]=t,i[3]=n,i}function Yt(u,e){return new Float32Array(u,e,4)}function Xe(){return qe()}function Qe(){return H(1,1,1,1)}function Je(){return H(1,0,0,0)}function et(){return H(0,1,0,0)}function tt(){return H(0,0,1,0)}function nt(){return H(0,0,0,1)}const kt=Xe(),Ht=Qe(),Wt=Je(),$t=et(),Zt=tt(),Kt=nt();Object.freeze(Object.defineProperty({__proto__:null,ONES:Ht,UNIT_W:Kt,UNIT_X:Wt,UNIT_Y:$t,UNIT_Z:Zt,ZEROS:kt,clone:Gt,create:qe,createView:Yt,fromValues:H,ones:Qe,unitW:nt,unitX:Je,unitY:et,unitZ:tt,zeros:Xe},Symbol.toStringTag,{value:"Module"}));const xe=new Map([["geometry",[new ne("a_pos",2,P.BYTE,0,2)]]]),ti=new Map([["geometry",[new ne("a_pos",2,P.BYTE,0,4),new ne("a_tex",2,P.BYTE,2,4)]]]),ni=new Map([["geometry",[new ne("a_pos",2,P.UNSIGNED_SHORT,0,4)]]]);let jt=class{constructor(e,t){this._rctx=e,this._attributes=[{name:"position",offset:0,type:P.SHORT,count:2}],this.layout={hash:xt(this._attributes),attributes:this._attributes,stride:4},this._vertexBuffer=k.createVertex(e,W.STATIC_DRAW,new Uint16Array(t)),this._vao=new Z(e,new Map([["a_position",0]]),new Map([["geometry",[new ne("a_position",2,P.SHORT,0,4)]]]),new Map([["geometry",this._vertexBuffer]])),this._count=t.length/2}bind(){this._rctx.bindVAO(this._vao)}unbind(){this._rctx.bindVAO(null)}dispose(){this._vao.dispose()}draw(){this._rctx.bindVAO(this._vao),this._rctx.drawArrays(A.TRIANGLE_STRIP,0,this._count)}},$=class{constructor(){this.name=this.constructor.name||"UnnamedBrush",this.brushEffect=null}prepareState(e,t){}draw(e,t,n){}drawMany(e,t,n){for(const i of t)i.visible&&this.draw(e,i,n)}};const de={nearest:{defines:[],samplingMode:B.NEAREST,mips:!1},bilinear:{defines:[],samplingMode:B.LINEAR,mips:!1},bicubic:{defines:["bicubic"],samplingMode:B.LINEAR,mips:!1},trilinear:{defines:[],samplingMode:B.LINEAR_MIPMAP_LINEAR,mips:!0}},qt=(u,e,t)=>{if(t.samplingMode==="dynamic"){const{state:n}=u,i=e.resolution/e.pixelRatio/n.resolution,o=Math.round(u.pixelRatio)!==u.pixelRatio,a=i>1.05||i<.95;return n.rotation||a||o||e.isSourceScaled||e.rotation?de.bilinear:de.nearest}return de[t.samplingMode]};let Xt=class extends ${constructor(){super(...arguments),this._desc={vsPath:"raster/bitmap",fsPath:"raster/bitmap",attributes:new Map([["a_pos",0]])}}dispose(){this._quad&&this._quad.dispose()}prepareState({context:e}){e.setBlendingEnabled(!0),e.setColorMask(!0,!0,!0,!0),e.setStencilWriteMask(0),e.setStencilTestEnabled(!0)}draw(e,t){const{context:n,renderingOptions:i,painter:o,requestRender:a,allowDelayedRender:r}=e;if(!t.source||!t.isReady)return;const l=qt(e,t,i),s=o.materialManager.getProgram(this._desc,l.defines);if(r&&a!=null&&!s.compiled)return void a();e.timeline.begin(this.name),t.blendFunction==="additive"?n.setBlendFunctionSeparate(N.ONE,N.ONE,N.ONE,N.ONE):n.setBlendFunctionSeparate(N.ONE,N.ONE_MINUS_SRC_ALPHA,N.ONE,N.ONE_MINUS_SRC_ALPHA),n.setStencilFunction(U.EQUAL,t.stencilRef,255),this._quad||(this._quad=new jt(n,[0,0,1,0,0,1,1,1]));const{coordScale:c,computedOpacity:_,transforms:f}=t;t.setSamplingProfile(l),t.bind(e.context,Ce),n.useProgram(s),s.setUniformMatrix3fv("u_dvsMat3",f.displayViewScreenMat3),s.setUniform1i("u_texture",Ce),s.setUniform2fv("u_coordScale",c),s.setUniform1f("u_opacity",_),this._quad.draw(),e.timeline.end(this.name)}};const Qt={background:{"background.frag":`uniform lowp vec4 u_color;
void main() {

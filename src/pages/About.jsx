      ...
      <div className="bg-gradient-to-r from-brand-primary to-brand-primary-dark text-brand-text-inverse py-20">
        <div className="max-w-6xl mx-auto px-4">
          ...
          <p className="text-xl md:text-2xl text-brand-background-light/90">
            Empowering Norwegian genealogical research through interactive
            mapping
          </p>
        </div>
      </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          ...
          <div className="md:col-span-2 space-y-12">
            ...
            <section className="prose max-w-none">
              <p className="text-brand-text-primary text-lg leading-relaxed">
                NorwayParishes.com is a free web application designed to assist
                those with Norwegian ancestry in conducting genealogical
                research. Created by Kristian Ekenes in 2014 during his
                master&apos;s degree in Geographic Information Systems at
                Arizona State University, this platform revolutionizes how
                people research their Norwegian heritage.
              </p>
            </section>

            {/* Primary Goal */}
            <section>
              <h2 className="font-heading text-3xl text-brand-primary mb-6">
                Our Mission
              </h2>
              <div className="bg-brand-background-paper p-8 rounded-xl shadow-sm border border-brand-primary/10">
                ...
                <ul className="space-y-4">
                  <li className="flex items-start">
                    <svg
                      className="h-6 w-6 mr-3 text-brand-secondary"
                      fill="none"
                      stroke="currentColor"
                      viewBox="0 0 24 24"
                    >
                    ...
                    <span className="text-brand-text-primary">
                      Interactive and precise maps of Norway&apos;s parish
                      boundaries
                    </span>
                  </li>
                  <li className="flex items-start">
                    ...
                    <span className="text-brand-text-primary">
                      Links to premier online genealogical research tools
                    </span>
                  </li>
                  <li className="flex items-start">
                    <svg
                    ...
                    <span className="text-brand-text-primary">
                      Advanced farm search capabilities
                    </span>
                  </li>
                </ul>
              </div>
            ...
            <section>
              ...
              <div className="bg-brand-background-paper p-8 rounded-xl shadow-sm border border-brand-primary/10">
                <p className="text-brand-text-primary text-lg mb-6">
                  Many people researching their family roots want to understand
                  more than just names and dates. They want to know:
                </p>
          ...
          <div className="space-y-8">
            ...
            <div className="bg-brand-background-paper p-8 rounded-xl shadow-sm border border-brand-secondary/20">
              <h3 className="font-heading text-2xl text-brand-primary mb-6">
                Features
              </h3>
              <ul className="space-y-4">
                <li className="flex items-center space-x-3">
            ...
            <div className="bg-brand-background-paper p-8 rounded-xl shadow-sm border-l-4 border-brand-accent-burgundy">
              <h3 className="font-heading text-xl text-brand-primary mb-4">
                A Note on Parish Boundaries
              </h3>
              <p className="text-brand-text-secondary">
                While county and municipal boundaries show current
                jurisdictions, parish boundaries reflect their 1979 status. This
                data comes from the Norwegian Mapping Authority and Norwegian
                National Archives.
              </p>
            </div>
          </div>

          ...
          <div className="">
            <div className="bg-brand-background-paper p-8 rounded-xl shadow-sm">
              ...
              <p className="text-brand-text-secondary mb-8">
                If you have questions, comments, or suggestions on how to
                improve NorwayParishes.com, we would love to hear from you. Also
                if you notice any errors in boundary locations or in other
                content found on this site, please report them so they can be
                fixed.
              </p>
